package com.zookeeper.delegate.clustering;
...
@Path("/clusteringDelegate")
public class DelegateStormClustering 
{
	...
	public String delegate() throws UnknownHostException, IOException 
	{
		...
		ServiceProvider<Void> serviceProvider = serviceDiscovery.serviceProviderBuilder().serviceName("stormClustering")
				.build();
		try 
		{
